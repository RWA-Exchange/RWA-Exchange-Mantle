// Mantle Faucet Script - Request MNT tokens for deployment
// Based on official Mantle TypeScript SDK documentation

const { getFaucetHost, requestSuiFromFaucetV0 } = require('@onelabs/sui/faucet');
require('dotenv').config();

async function fundWallet() {
  console.log('🚰 Mantle Faucet - Requesting MNT Tokens...');
  ...
  try {
    console.log('🔍 Requesting MNT tokens from Mantle testnet faucet...');
    ...
    console.log('💰 MNT tokens should be available in your wallet shortly');
    console.log('🔍 Check balance at: https://testnet-explorer.Mantle.network/address/' + recipientAddress);
