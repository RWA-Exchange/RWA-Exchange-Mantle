    ...
    try {
        ...
        if (proofPack.contracts.deployerAddress) {
            try {
                ...
                const propertyObjects = objects.data.filter(obj => obj.data?.type?.includes('property_nft::PropertyNFT'));
        ...
        if (proofPack.contracts.deployerAddress) {
            try {
                ...
                const investmentObjects = objects.data.filter(obj => obj.data?.type?.includes('property_nft::Investment'));
