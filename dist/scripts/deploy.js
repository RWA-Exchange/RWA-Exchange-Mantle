...
async function main() {
    ...
    console.log("Account balance:", hardhat_1.ethers.formatEther(await deployer.provider.getBalance(deployer.address)), "MNT");
    console.log("=".repeat(60));
    ...
    try {
        ...
        (0, fs_1.writeFileSync)(filename, JSON.stringify(deploymentInfo, null, 2));
