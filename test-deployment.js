// Quick test script to verify Mantle connection
const { SuiClient } = require('@mysten/sui/client');

const RPC_URL = process.env.NEXT_PUBLIC_Mantle_RPC_URL || 'https://rpc-testnet.onelabs.cc:443';

async function testConnection() {
  console.log('🔍 Testing Mantle connection...');
  ...
  try {
    ...
    console.log('✅ Connected to Mantle!');
